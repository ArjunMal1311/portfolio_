            ...
            <div className='-my-4 flex justify-center gap-8 py-4 sm:w-full'>
                <div className='relative h-80 flex-none overflow-hidden rounded-xl bg-zinc-800 w-72 sm:rounded-2xl sm:rotate-2'>
                    <div className="card-2">
                        <div className="top">
                            <p className="title">ml_model.py</p>
                            <span className="buttons space-x-3 mr-2">
                        ...
                        <div className="content mt-2">
                            <p>
                                <code>
                                    ...
                                    <div className='text-green-500 text-[13px]'># Pandas: For when you're too cool for spreadsheets.</div>
                                    <br />
                                    <div><span className='text-blue-400'>import</span> numpy <span className='text-blue-400'>as </span>np</div>
                                    <div className='text-green-500 text-[13px]'># NumPy: Because life is too short for regular arrays.</div>
                                    <br />
                                    <div><span className='text-blue-400'>import</span> seaborn <span className='text-blue-400'>as </span>sns</div>
                                    <div className='text-green-500 text-[13px]'># Seaborn: Adding style to data, without the salon prices.</div>
                                </code>
                            </p>
                        </div>
                    </div>
                ...
                <div className='relative h-80 flex-none overflow-hidden rounded-xl bg-zinc-800 w-72 sm:rounded-2xl sm:-rotate-2'>
                    <div className="w-full h-full">
                        ...
                        <div className=" pt-2 mt-[-1px] text-[15px] rounded-bl-[5px] rounded-br-[5px] px-2">
                            <div className="flex">
                                <span className="ml-[4px] text-white">arjun@admin:</span>
                                <span className="ml-[4px] text-[#4878c0]">~</span>
                                <span className='text-green-300'><span className='text-yellow-500'>echo</span> "AI/ML, MERN, Next, Mentoring, DSA, JavaScript, ML Conference Speaker, YouTube Creator"</span>
                        ...
                        <div className="  pt-2 mt-[-1px] text-[15px] rounded-bl-[5px] rounded-br-[5px] px-2">
                            <div className="flex">
                                <span className="ml-[4px] text-white">arjun@admin:</span>
                                <span className="ml-[4px] text-[#4878c0]">~</span>
                                <span className='text-green-300'><span className='text-yellow-500'>echo</span> "Web Sockets, Framer-Motion, REST, UI/UX, Git, Tailwind, Redux, Typescript"</span>
                                <span className="block h-[14px] w-[5px] ml-[10px] terminal_cursor"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div className='sm:flex hidden relative h-80 flex-none overflow-hidden rounded-xl w-72 sm:rounded-2xl sm:rotate-2'>
                ...
                <div className='relative h-80 flex-none overflow-hidden rounded-xl bg-zinc-800 w-72 sm:rounded-2xl rotate-4'>
                    <aside className=" text-white p-6 rounded-lg w-full h-full max-w-lg font-mono">
                        ...
                        <div className="mt-4">
                            <p className="text-green-400">$ npm install caffeine-for-coders@latest</p>
                            <p className="text-white my-2">☕️ "code-rocket-fuel" added — 100% productivity boost!</p>
                            <p className="text-white my-2">🚀 1 package, audited 2 in 3s ⚡️💻</p>
